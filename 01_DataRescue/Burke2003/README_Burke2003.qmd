...
studyMeta <- tribble(~site_id, ~of_variable, ~is_type, ~with_entry, ~from_source,
  # Hawaii
  'Hawaii', 'region', 'value', 'Hamakua Coast, Hawaii, northeast flank of Mauna Kea', paste('Method ln7:', data.lvl0.df$method[7]),
  ...
  'Hawaii', 'soil_age', 'value', '15000 to 20000', paste('Method ln8:', data.lvl0.df$method[8]),
  'Hawaii', 'soil_age', 'unit', 'yr', paste('Method ln8:', data.lvl0.df$method[8]),
  'Hawaii', 'total_rainfall', 'value', '2500 to 4000', paste('Method ln9:', data.lvl0.df$method[9]),
  'Hawaii', 'total_rainfall', 'unit', 'mm', paste('Method ln9:', data.lvl0.df$method[9]),
  'Hawaii', 'mean_air_temperature', 'value', '22', paste('Method ln10:', data.lvl0.df$method[10]),
  'Hawaii', 'mean_air_temperature', 'unit', '°C', paste('Method ln10:', data.lvl0.df$method[10]),
  ...
  # Brazil
  'Brazil', 'region', 'value', 'Piracicaba, São Paulo, Brazil', paste('Method ln23:', data.lvl0.df$method[23]),
  ...
  'Brazil', 'total_rainfall', 'value', '1400', paste('Method ln24:', data.lvl0.df$method[24]),
  'Brazil', 'total_rainfall', 'unit', 'mm', paste('Method ln24:', data.lvl0.df$method[24]),
  'Brazil', 'mean_air_temperature', 'value', '20', paste('Method ln24:', data.lvl0.df$method[24]),
  'Brazil', 'mean_air_temperature', 'unit', '°C', paste('Method ln24:', data.lvl0.df$method[24]),
  'Brazil', 'soil_class', 'value', 'Typic Haplorthox', paste('Method ln25:', data.lvl0.df$method[25]),
  'Brazil', 'stand_age', 'value', '27 and 65', paste('Method ln28:', data.lvl0.df$method[28]),
